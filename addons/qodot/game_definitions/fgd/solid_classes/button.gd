...
func body_shape_entered(body_id: RID, body: Node, body_shape_idx: int, self_shape_idx: int) -> void:
...
func body_shape_exited(body_id: RID, body: Node, body_shape_idx: int, self_shape_idx: int) -> void:
	if body is StaticBody:
		return
